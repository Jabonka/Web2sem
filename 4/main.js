...
const material = new THREE.MeshPhongMaterial({color:'deeppink', side: THREE.DoubleSide });
...
let material1 = new THREE.MeshPhongMaterial({color: 'deeppink'});
...
function animate() {
    ...
    camera.position.x = Math.cos(elapsedTime * 0.5) * 30;
    camera.position.z = Math.sin(elapsedTime * 0.5) * 30;
    camera.lookAt(cameraTarget);
